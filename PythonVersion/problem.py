...
# Constructor for the problem with jobs, number of machines, energy prices and due dates
    def __init__(self, jobTasks, nJobs, nTasks, nMachines, energyPrices, dueDates, passiveEnergy, tasksMachines, mutationProb, thresholdGenetic, nIndividual, xoverProb):
