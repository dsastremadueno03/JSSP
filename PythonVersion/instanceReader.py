...
class InstanceReader:
    ...
    def __init__(self, pathIntances, pathPreparedJobs, pathTOUPrices, pathPassiveEnergy, pathMutationProb):
        self.problem = Problem([], 0, 0, 0, [], [], [], [], 0, 0, 0, 0, 0, 0) # Initialize the problem
    ...
    def readMutationProb(self):
        ...
        for i in range(11): # Fixed number of params to read
    ...
    def transformTOUPricesData(self, data):
        ...
        for i in range(len(fixedData)):
            for j in range(60): # For each minute
                finalData.append(int(fixedData[i])/60.0/100.0) # Obtain decimal value (/60 for minutes, /100 for two-digit decimal value)
    ...
    def transformMutationProbData(self, data):
        ...
        self.problem.peakHoursAvoided = data[10]
